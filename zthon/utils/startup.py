    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/60b0eb8a34700bc925bdc.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس حزين الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("قناة السورس", "https://t.me/ppqnu"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "ppqnu")
...
zthon = {"@ppqnu", "@def_Zoka", "@reffezk", "@VVGVGGV", "@nennnun"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/ppqnu.jpg")
